...
namespace Shader {
	...
	*シェーダープログラムを作成する
	*
	*@param vsCode 頂点シェーダへのポインタ
	*@param fsCode フラグメントシェーダへのポインタ
	*
	...
	*/
	...
	/**
	*Uniform ブロックをバインディングポイントに割り当てる
	*
	...
	*/
	...
	/**
	*テクスチャをテクスチャイメージユニットに割り当てる
	*
	*@param unit    割当先のテクスチャイメージユニット番号(GL_TEXTURE~)
	...
	*@param fsCode fragmentシェーダコードへのポインタ
	*
	*@return 作成したプログラムオブジェクト
	*/
